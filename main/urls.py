...
from main.views import show_login,show_register,show_home, daftar_favorit, daftar_unduhan, show_trailer, show_episode, show_tayangan, insert_ulasan, compute_riwayat_nonton
